...
class MoviedbResponse {
    ...
    factory MoviedbResponse.fromJson(Map<String, dynamic> json) => MoviedbResponse(
        dates: json["dates"] != null ? Dates.fromJson(json["dates"]) : null, // this was fixed because we made date prop optional
        page: json["page"],
    ...
    Map<String, dynamic> toJson() => {
        "dates": dates?.toJson(), // this was fixed because we made date prop optional
        "page": page,
